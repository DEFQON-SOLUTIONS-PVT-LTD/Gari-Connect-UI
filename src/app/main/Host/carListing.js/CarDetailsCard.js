                    ...
                    <CardContent>
                        <div className="flex flex-row items-center -mt-31 mb-2">
                            <div className="bg-white py-2 px-4 rounded-sm flex flex-row space-x-6 mt-12">
                                ...
                                <Typography className="font-normal" color='text.secondary'>15 Trips</Typography>
                        ...
                        <div className="flex flex-row justify-between">
                            <div className="flex flex-col">
                                ...
                                <Typography className="text-sm font-normal mr-auto mb-12" variant="" color="text.secondary">
                                    Gulberg 3, Lahore
                                </Typography>
                            </div>
                            <div className="flex flex-col">
                        ...
                        <div className="flex flex-row justify-between">
                            <div className="flex flex-col">
                                ...
                                <Typography className="mr-auto rounded-16 p-8 mt-20" style={{backgroundColor: '#30C07D14', color: '#30C07D'}}>
