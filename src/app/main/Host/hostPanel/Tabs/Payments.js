         ...
         <div className="flex-row grid sm:grid-cols-3 grid-cols-1 gap-10">
          ...
          <Card className="rounded-md border col-span-1">
            <CardContent>
              <div className="flex flex-row">
                <div className="flex flex-col space-y-28">
                  <Typography className="text-16 font-medium">Current Blance</Typography>
                  <div className="space-y-14">
                    <Typography className="text-3xl font-semibold">4200 PKR</Typography>
                    <Typography className="flex flex-row space-x-8">
                    
                      <span className="text-sm font-medium" style={{color: '#D22A8F'}}>Get paid</span>
                    </Typography>
                  </div>
                </div>
                        ...
                        <div className="flex flex-row items-center">
                            <Box sx={{ width: '100%'}} >
                                <Box sx={{ p: 1 }}>
                                    ...
                                    >
                                        <Tab className='md:ml-0 ml-10'  label={<Typography className="text-sm font-medium">Payments</Typography>} onClick={()=> setstatus(false)}/>
                                        <Tab className='md:ml-0 ml-10' label={<Typography className="text-sm font-medium">Transactions history</Typography>} onClick={()=> setstatus(true)} />
