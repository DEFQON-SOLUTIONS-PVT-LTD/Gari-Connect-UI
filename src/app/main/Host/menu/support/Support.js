...
const card = (
  <React.Fragment>
    ...
    <CardActions>
      <Button size="small" sx={{ color: "#D22A8F" }}>
        Read more
      </Button>
    </CardActions>
  </React.Fragment>
    ...
    <div className="bg-gray-50 h-full">
      ...
      <div className="mx-auto w-5/6 py-24">
        <div className="flex flex-row items-center mx-auto mb-28">
          <IconButton className="mr-20" component={Link} to="HostTabs">
        ...
        <div className="flex flex-1 justify-between items-center mb-20">
          <ThemeProvider theme={mainTheme}>
            <Paper
              ...
              className="flex items-center  shadow-none border w-full max-w-512 px-8 py-4 rounded-16 "
            >
              <Input
        ...
        <div className="">
          <Box
            sx={{}}
            className=" justify-around grid sm:grid-cols-3 md:grid-cols-4 grid-cols-1 gap-10"
          >
            <Card variant="outlined" className="rounded-md col-span-1">
              {card}
            </Card>
            <Card variant="outlined" className="rounded-md col-span-1">
              {card}
      ...
      >
        <DialogTitle className="border-b mb-16 flex flex-row justify-between items-center">
          <Typography className="text-xl">Report a problem</Typography>
        ...
        <DialogActions>
          <Button
            ...
            onClick={handleClose}
            size="large"
            className="mx-14 mb-20 rounded-md text-white"
            style={{ backgroundColor: "#D22A8F" }}
          >
            Submit
          </Button>
