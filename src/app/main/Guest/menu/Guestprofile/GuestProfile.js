          ...
          <div className="col-span-1">
            <Card className="flex flex-col items-center border shadow-none rounded-md">
              <CardContent className="">
                <img
                  className="my-24"
                  src="assets/images/profile/Hassan.png"
                  alt=""
                />
                <Typography className="text-2xl text-center font-Manrope font-semibold">
                  Hassan Ali
                </Typography>
                ...
                <div className="">
                  <Typography
                    className="text-12 font-normal mb-10"
                    color="text.secondary"
                  >
                    Address
                  </Typography>
                  <Typography className="text-14 font-medium mb-20">
                    St. 36 Block D, Gulberg 2. Lahore
                  </Typography>
            ...
            <Card className="flex flex-col items-start border shadow-none rounded-md h-full">
              <CardContent className="ml-40 pt-28">
                <div className="flex flex-row items-center mb-32">
                  <Typography className="text-16 font-semibold mr-14">
                    Reviews and ratings
                  </Typography>
                  <Rating
                    className="mr-12"
                  ...
                  <div className="flex mb-10">
                    ...
                    <div className="">
                      <div className="flex items-center">
                        ...
                        />
                        <Typography
                          className="text-14 font-normal ml-10"
                          style={{ color: "#000000" }}
                        >
                          4.0
                        </Typography>
